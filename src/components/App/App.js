...
import { DesktopRoute, MobileRoute } from '../ResponsiveRoute';
...
class App extends PureComponent {
  ...
  //         {/*
  //           NOTE: These routes are copied from loggedOutRoutes.
  //           I ought to take some time and refactor how these routes are organized.
  //         */}
  ...
  render() {
    ...
    return [
      ...
      <Switch key="routes">
        // Landing page route (redirects to SummaryView if authenticated)
        <Route exact path="/" component={LandingPageView} />

        // Logged-in desktop routes
        <AuthenticatedRoute path="/summary" component={SummaryView} />
        <AuthenticatedRoute path="/backlog" component={BacklogView} />
        <AuthenticatedRoute path="/calendar" component={CalendarView} />
        <AuthenticatedRoute path="/settings" component={SettingsView} />

        // Logged-in mobile route (uses swiping internally to change views)
        <AuthenticatedRoute path="/mobile" component={MobileView} />
