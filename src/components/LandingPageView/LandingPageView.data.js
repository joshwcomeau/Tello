...
const gameOfThrones = {
  ...
  "image": "http://static.tvmaze.com/uploads/images/original_untouched/124/310209.jpg",
  "status": "Running",
  "type": "Scripted",
...
const sharkTank = {
  ...
  "episodes": {
    ...
    "926905": {
      "id": 926905,
      "name": "Raising Wild, The Cookie Kahuna, TekDry, Night Runner, Angels and Tomboys",
      "season": 8,
      "number": 3,
    ...
    "936161": {
      "id": 936161,
      "name": "Angels and Tomboys, Atlantic Candy Company, The biēm Butter Sprayer, Solemates",
      "season": 8,
      "number": 4,
    ...
    "993989": {
      "id": 993989,
      "name": "An Entrepreneur Who Works with Santa to Reply to Children's Letters, 83-Year-Old Ironman Triathlon Competitor, Profile of Billionaire Mark Cuban",
      "season": 8,
      "number": 11,
    ...
    "1013690": {
      "id": 1013690,
      "name": "Naturally Perfect Dolls, PDX Pet Design, Basic Outfitters, Victory Coffees",
      "season": 8,
      "number": 12,
    ...
    "1023462": {
      "id": 1023462,
      "name": "Tiny House Rentals; Snack Chips with Cricket Flour; Earplugs That Filter Damaging Sounds; Modernized Childhood Toy",
      "season": 8,
      "number": 14,
    ...
    "1031909": {
      "id": 1031909,
      "name": "Stylish Baby Mats; Portable Pressurized Shower Kit; Folding Smart-Cart",
      "season": 8,
      "number": 15,
    ...
    "1048804": {
      "id": 1048804,
      "name": "A Vibrating Mat That Helps Calm Babies; An Ointment Made From Essential Oils; A Natural Snack Made With Acai",
      "season": 8,
      "number": 16,
    ...
    "1048805": {
      "id": 1048805,
      "name": "An App That Allows Children To Use A Plush Toy To Send And Receive Voicemail; Software That Automates Plant Care",
      "season": 8,
      "number": 17,
    ...
    "1050340": {
      "id": 1050340,
      "name": "Food Supplements, Drone Pilot Training and Educational Courses, Elephant-Themed Apparel and Stylish Beach Towels",
      "season": 8,
      "number": 18,
...
const ninetyDayFiance = {
  ...
  "name": "90 Day Fiancé",
  "image": "http://static.tvmaze.com/uploads/images/original_untouched/17/43103.jpg",
  "status": "Running",
  "type": "Reality",
...
const stevenUniverse = {
  ...
  "image": "http://static.tvmaze.com/uploads/images/original_untouched/8/22200.jpg",
  "status": "Running",
  "type": "Animation",
  "summary": "Steven Universe, from Adventure Time writer-artist Rebecca Sugar, is a coming-of-age story told from the perspective of Steven, the youngest member of a team of magical Guardians of the Universe.",
  "region": "US",
  "seenEpisodeIds": [],
  "episodes": {
    "881988": {
...
export const SHOWS = [strangerThings, sharkTank, gameOfThrones, stevenUniverse, ninetyDayFiance];
